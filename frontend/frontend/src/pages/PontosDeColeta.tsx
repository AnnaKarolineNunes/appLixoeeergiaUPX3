...
export default function PontosColeta() {
    ...
    const handleNavigateInfo = (collectionPoint: string, address: string) => {
        navigate("/instrucoes", { state: { collectionPoint, address } });
    };
        ...
        <div className="flex flex-col h-screen">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-white space-y-4">
                <div className="bg-[#F5F5F5] rounded-lg w-[360px] h-[110px] flex items-center p-4 relative">
                    <button onClick={() => handleNavigateInfo("Estação zona Norte", "Rua Bari, 123 - Bairro Guarani")}>
                        <img
                            src={pontoColetas}
                            width="150"
                            height="80"
                ...
                <div className="bg-[#F5F5F5] rounded-lg w-[360px] h-[110px] flex items-center p-4 relative">
                    <button onClick={() => handleNavigateInfo("Estação zona sul", "Rua Aquiri, 123 - Bairro Guarani")}>
                        <img
                            src={pontoColetas}
                            width="150"
                            height="80"
